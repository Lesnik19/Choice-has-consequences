...
screen main_menu():
    ...
    imagemap:
        ...
        idle "gui/buttons.png"
        hover "gui/buttons_activ.png"
        
        hotspot(380, 30, 380, 100) action Start()
        hotspot(370, 175, 540, 110) action ShowMenu("load")
        hotspot(380, 330, 545, 100) action ShowMenu("preferences")
        hotspot(380, 470, 410, 110) action ShowMenu("about")
        hotspot(370, 600, 410, 110) action ShowMenu("gallery")
        hotspot(380, 780, 230, 70) action ShowMenu("help")
        hotspot(380, 900, 180, 60) action Quit(confirm=True)
...
screen gallery():
    ...
    grid 4  3 :
        ...
        add g.make_button("poster dungeon", "poster dungeon", xalign=0.5, yalign=0.5)
        add g.make_button("poster boards", "poster boards", xalign=0.5, yalign=0.5)
        add g.make_button("poster shark", "poster shark", xalign=0.5, yalign=0.5)
        add g.make_button("poster shark2", "poster shark2", xalign=0.5, yalign=0.5)
        add g.make_button("poster shark3", "poster shark3", xalign=0.5, yalign=0.5)
        add g.make_button("poster thrall", "poster thrall", xalign=0.5, yalign=0.5)
        add g.make_button("poster ninja", "poster ninja", xalign=0.5, yalign=0.5)
        add g.make_button("poster money", "poster money", xalign=0.5, yalign=0.5)
        add g.make_button("poster rich", "poster rich", xalign=0.5, yalign=0.5)
        add g.make_button("poster repay", "poster repay", xalign=0.5, yalign=0.5)
        add g.make_button("poster looking", "poster looking", xalign=0.5, yalign=0.5)
        
    
    textbutton "Назад" text_color "#aaaaaa" text_hover_color "#0055ff" action Return() xalign 0.5 yalign 0.95
