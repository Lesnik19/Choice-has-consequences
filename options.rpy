...
define config.name = _("Выбор имеет значение")
...
define gui.about = _p("""
Игра ещё находится в разработке.

Музыка взята с курса по Scretch (Скретч) от Айтик
""")
...
define build.name = "Choicehasconsequences"
...
define config.save_directory = "Choicehasconsequences-1717216562"
...
define config.window_icon = "gui/footman.png"
